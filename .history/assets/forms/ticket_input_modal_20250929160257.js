    ...
    waitForElements(({ modal, form, submitBtn, cancelBtn, closeBtn, loadingOverlay, rawInput, parsedPreview, parseError, charCounter }) => {
      ...
      function parseTicketInput(rawText) {
        ...
        lines.forEach((line, index) => {
          ...
          // Enhanced parsing: Handle "Key: Value" or "Key - Value" formats
        ...
        // Validate parsed data (require at least type/description)
        const hasEssentialData = ticketData.type || ticketData.description || Object.keys(ticketData).length > 0;
        if (!hasEssentialData) {
          parseError.textContent = 'No valid key-value pairs found. Use format like "Type: Hardware" or "Description: Issue details".';
      ...
      form.addEventListener('submit', async (e) => {
        ...
        const ticketData = {
          ...
          type: parsedTicketData.data.type || 'General',
