          ...
          <section class="form-section">
            <div class="form-group" style="display: flex; flex-direction: column;">
              ...
              <select name="requestType" required data-required="true" style="
                    ...
                    <option value="Not_Feeling Well">Not Feeling Well</option>
                    <option value="family_emergency">Family Emergency</option>
                    <option value="personal_appointment">Personal Appointment</option>
                    <option value="school_or_training">School / Training Related</option>
                    <option value="urgent_task">Urgent Personal Task</option>
                    <option value="other">Other</option>
                    </select>
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (window.TelegramConnect && typeof window.TelegramConnect.sendRequest === 'function') {
      await window.TelegramConnect.sendRequest({ id: docRef.id, ...restData }, 'Early Rest Day');
    }
