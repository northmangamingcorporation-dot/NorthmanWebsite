            ...
            ">
              ...
              <div class="form-group" style="display: flex; flex-direction: column; grid-column: 1 / -1;">
                ...
                ">
                  ...
                  <small style="color: #9ca3af; font-size: 12px;">Upload up to 5 image files (max 5MB each) as proof of accomplishment. Supported: JPG, PNG, GIF. Paste (Ctrl+V) anywhere in the form.</small>
...
function attachAccomplishmentForm(user) {
  ...
  function setupDragAndDrop() {
    ...
    // UPDATED: Global paste listener on FORM (listens anywhere in form for Ctrl+V)
    ...
    function handlePaste(e) {
      ...
      if (files.length > 0) {
        ...
        dropZone.focus();
      } else if (items.length > 0 && !files.length) {
        showDropError('No valid images found in clipboard. Try copying a screenshot or image (e.g., PrtScn + Ctrl+V).');
      } else {
        // Silent ignore if no files in clipboard (e.g., text paste)
        console.log('No files in clipboard paste event.');
      }
    }
    ...
    dropZone.addEventListener('focusin', () => {
      if (!dropZone.classList.contains('drag-over')) {
        ...
        `;
        hint.textContent = 'Paste images with Ctrl+V (works anywhere in form)';
