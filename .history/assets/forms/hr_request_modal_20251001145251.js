          ...
          <section class="form-section">
            <div class="form-group" style="display: flex; flex-direction: column;">
              ...
              <select name="requestType" required data-required="true" style="
                    ...
                    <option value="School / Training Related">School / Training Related</option>
                    <option value="Urgent Personal Task">Urgent Personal Task</option>
                    <option value="Other">Other</option>
                    </select>
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (!window.db) {
        ...
        dateSubmitted: docReffirebase.firestore.FieldValue.serverTimestamp(),
...
form.addEventListener('submit', async (e) => {
  ...
  try {
        ...
        updatedAt: formatFirestoreDate(firebase.firestore.FieldValue.serverTimestamp())
        };
