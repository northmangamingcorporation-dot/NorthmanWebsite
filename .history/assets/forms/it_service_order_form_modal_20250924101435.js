  ...
  return `
    <div id="itServiceModal" 
         style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); 
                display:flex; align-items:center; justify-content:center; padding:16px; overflow:auto; z-index:1000; font-family: Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial;">
      
      <div style="background: linear-gradient(145deg, #ffffff, #f0fdfa); border-radius:12px; max-width:800px; width:100%; padding:28px; position:relative; 
