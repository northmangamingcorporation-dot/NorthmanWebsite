...
function renderLeaveRequestForm(user = { username: "Employee", firstName: "User" }) {
...
function showLeaveRequestModal(user) {
...
function showEarlyRestModal(user) {
