...
function renderDriversTripTicketForm() {
  return `
    <div id="driversTripTicketModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); display:flex; align-items:center; justify-content:center; padding:16px; overflow:auto; z-index:1000;">
      <div style="background: linear-gradient(145deg, #ffffff, #f0fdfa); border-radius:12px; max-width:650px; width:100%; padding:24px; position:relative; box-shadow:0 10px 25px rgba(0,0,0,0.2); font-family: Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial;">
