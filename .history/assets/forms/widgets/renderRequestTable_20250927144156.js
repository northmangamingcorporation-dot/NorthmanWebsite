// UPDATED: Standalone loadOrders function for IT service orders table
...
// Assumes: ordersCol (Firestore collection, e.g., window.db.collection("it_service_orders")), unsubscribe (outer scope variable),
// getStatusColor, updateStats, getCurrentStats, hideLoading (defined elsewhere, e.g., in attachDashboard).
// Usage: Call loadOrders(currentUser   ) to populate #requestsTable with real-time data.
