    ...
    return `
        <div class="time-filter">
            <div class="filter-mode-selector">
                <button class="filter-mode-btn ${state.timeRange === 'day' ? 'active' : ''}" 
                        onclick="window.AnalyticsWidget.changeFilterMode('day')">
                    <i class="fas fa-calendar-day"></i> Daily
                </button>
                <button class="filter-mode-btn ${state.timeRange === 'week' ? 'active' : ''}" 
                        onclick="window.AnalyticsWidget.changeFilterMode('week')">
                    <i class="fas fa-calendar-week"></i> Weekly
                </button>
                <button class="filter-mode-btn ${state.timeRange === 'month' ? 'active' : ''}" 
                        onclick="window.AnalyticsWidget.changeFilterMode('month')">
                    <i class="fas fa-calendar-alt"></i> Monthly
                </button>
                <button class="filter-mode-btn ${state.timeRange === 'custom' ? 'active' : ''}" 
