...
// Optional: Simple showLoading/hideLoading functions (if not globally available - creates spinner overlay)
function showLoading(loadingId) {
  if (document.getElementById(loadingId)) return;  // Already shown
  ...
  overlay.innerHTML = `
    <div style="text-align: center; color: #64748b;">
      <i class="fas fa-spinner fa-spin" style="font-size: 48px; margin-bottom: 16px; color: #0ea5a4;"></i>
      <p style="margin: 0; font-size: 16px;">Loading accomplishments...</p>
    </div>
  `;
...
function mountAccomplishmentTable(user) {
  ...
  thead.innerHTML = `
    <tr>
      ...
      <th style="width: 15%;"><i class="fas fa-tag" style="margin-right: 6px; color: #0ea5