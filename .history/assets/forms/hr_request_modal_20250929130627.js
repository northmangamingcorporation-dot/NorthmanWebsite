...
function showLeaveRequestModal(user = window.currentUser ) {
...
function showEarlyRestModal(user = window.currentUser ) {
...
function initializeLeaveForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      await window.db.collection('leave_requests').add(leaveData);
...
function initializeEarlyRestForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      await window.db.collection('early_rest_requests').add(restData);
