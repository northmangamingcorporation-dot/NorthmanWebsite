...
function attachDriversTripTicketForm(preFillUsername = "") {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    const data = { id, status: "Pending", dateSubmitted: firebase.firestore.FieldValue.serverTimestamp(), username: preFillUsername };
  ...
  // Fullscreen image preview & zoom/pan code remains unchanged
