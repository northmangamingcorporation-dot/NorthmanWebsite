...
function renderITServiceOrderForm() {
  return `
    <form id="itServiceForm" class="modal-form space-y-4">
  <!-- Use grid layout -->
  <div class="grid grid-cols-2 gap-4">
    ...
    <div class="form-group">
      <label class="block font-semibold mb-1">Contact (Email/Phone)</label>
    ...
    <!-- Request Details -->
    <div class="form-group">
      <label class="block font-semibold mb-1">Type of Request</label>
    ...
    <div class="form-group">
      <label class="block font-semibold mb-1">Priority Level</label>
    ...
    <div class="form-group">
      <label class="block font-semibold mb-1">Asset/Device Involved</label>
    ...
    <div class="form-group col-span-2">
      <label class="block font-semibold mb-1">Problem / Request Description</label>
  ...
  <div class="flex justify-end gap-3 mt-4">
    <button type="button" id="cancelITForm" class="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300">
      Cancel
    </button>
    <button type="submit" class="px-4 py-2 rounded-lg bg-teal-500 text-white hover:bg-teal-600">
      Submit
    </button>
  </div>
</form>
