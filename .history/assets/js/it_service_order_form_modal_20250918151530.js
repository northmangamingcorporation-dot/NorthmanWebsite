...
function renderITServiceOrderForm() {
  return `
    <div id="itServiceModal" class="fixed inset-0 z-50 display: items-center justify-center bg-black/50 p-4 overflow-auto">
        ...
        <form id="itServiceForm" class="space-y-6">
          ...
          <div class="flex justify-end gap-4 mt-4">
            <button type="button" id="cancelITForm"
                    class="px-5 py-3 rounded-lg bg-gray-200 hover:bg-gray-300 font-semibold">
              Cancel
            </button>
            <button type="submit"
                    class="px-5 py-3 rounded-lg bg-teal-500 text-white hover:bg-teal-600 font-semibold">
              Submit
            </button>
          </div>
