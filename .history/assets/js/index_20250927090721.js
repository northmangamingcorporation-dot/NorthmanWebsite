        ...
        <div class="ngc-footer-bottom">
          ...
          <div class="ngc-footer-social">
            ...
            <div class="ngc-social-links">
              <a href="#" class="ngc-social-link" aria-label="Facebook">
                <i class="fab fa-facebook"></i>
              </a>
              <a href="#" class="ngc-social-link" aria-label="Twitter">
                <i class="fab fa-twitter"></i>
              </a>
              <a href="#" class="ngc-social-link" aria-label="Instagram">
                <i class="fab fa-instagram"></i>
              </a>
              <a href="#" class="ngc-social-link" aria-label="LinkedIn">
...
/* --- Enhanced event wiring with proper error handling --- */
function attachActions() {
  try {
    ...
    if (contactPortalBtn) {
      contactPortalBtn.addEventListener("click", handleContactPortalClick);
    }
    ...
    console.error("Error in attachActions:", error);
  }
}

// Separated event handlers for better maintainability
function handleGetStartedClick() {
  ...
  setTimeout(() => {
    try {
      if (typeof window.mountLogin === 'function') {
        window.mountLogin();
      } else {
        console.warn("mountLogin function not available");
      }
    } catch (error) {
      console.error("Error mounting login:", error);
    } finally {
      btn.innerHTML = '<i class="fas fa-sign-in-alt"></i><span>Access Portal</span>';
      btn.disabled = false;
    }
  }, 500);
}
...
function handleContactPortalClick() {
  const btn = document.getElementById("contactPortalBtn");
  if (!btn) return;
  ...
  setTimeout(() => {
    try {
      ...
      btn.innerHTML = '<i class="fas fa-rocket"></i><span>Access Portal</span>';
      btn.disabled = false;
    }
  }, 500);
}
...
function handleNavClick(e) {
  ...
  if (route === 'home') {
    ...
    // For section navigation, scroll to section
