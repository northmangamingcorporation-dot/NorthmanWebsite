...
function attachRequestModal(preFillUsername = "") {
      ...
      switch(type) {
        ...
        case "IT Service Order":
          ...
          if (typeof mountITServiceForm === "function") {
            mountITServiceForm(preFillUsername );
          } else {
