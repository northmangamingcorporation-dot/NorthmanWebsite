    ...
    <div id="requestModal" class="modal-overlay">
      <div class="modal-card">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
          ...
          <div class="req-card" data-type="IT Service Order" style="grid-column: span 2;" onClick="mountITServiceForm()">
            <div class="emoji" onClick="mountITServiceForm()">💻</div>
            <div class="title" onClick="mountITServiceForm()">IT Service Order</div>
          </div>
        </div>
      </div>
    </div>
...
function attachRequestModal() {
  ...
  modal.querySelectorAll(".req-card").forEach(card => {
    card.addEventListener("click", () => {
      ...
      switch(type) {
        case "Travel Order":
          console.log("Travel Order clicked");
          // mountTravelOrderForm();
          break;

        case "Driver Trip Ticket":
          console.log("Driver Trip Ticket clicked");
          // mountDriverTripForm();
          break;
