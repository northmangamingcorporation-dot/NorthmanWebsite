...
// NorthmanWebsite/assets/js/index.js

// Core mount function: injects HTML into #root
function mount(html) {
  document.getElementById("root").innerHTML = html;
  if (typeof attachActions === "function") attachActions(); // attach home/dashboard actions
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.mountLogin) {
    ...
    console.error("mountLogin is not defined. Did you load pages/login.js before index.js?");
  }
});
