...
function renderTravelOrderForm() {
  return `
    <div id="travelOrderModal" 
      ...
      <div style="background:white; border-radius:12px; max-width:850px; width:100%; padding:28px; position:relative; box-shadow:0 10px 25px rgba(0,0,0,0.2); animation:fadeIn 0.3s ease;">
        ...
        <form id="travelOrderForm" style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px, 1fr)); gap:16px;">
    ...
    <div id="loadingTravelModal" 
         style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.4); display:flex; align-items:center; justify-content:center; z-index:2000;">
      <div style="background:white; padding:20px 30px; border-radius:10px; box-shadow:0 8px 20px rgba(0,0,0,0.25); color:#0ea5a4; font-weight:500;">
        Saving Travel Order...
      </div>
    </div>
