...
window.TelegramConnect = (function () {
  ...
  // Map request types to Telegram mentions
  const mentions = {
    "IT Service Order": "@it_team",
    "Travel Order": "@hr_team",
    "Maintenance Request": "@maintenance_team"
  };
  ...
  return {
    sendRequest: async function(dataObj, requestType) {
      ...
      // FOOTER with mention
      const mention = mentions[requestType] ? `\n*Attention:* ${mentions[requestType]}` : "";
      message += `\n*Sent via:* Automated Request System${mention}`;
