...
function mountDashboard(user) {
  ...
  // Wait a microtask to ensure DOM is rendered
  setTimeout(() => {
    // New Request button
    ...
    if (newReqBtn) {
      newReqBtn.addEventListener("click", () => {
        ...
        if (typeof mountRequestModal === "function") {
          ...
          console.error("mountRequestModal() is not loaded!");
        }
      });
    } else {
      console.warn("New Request button not found!");
    }
