      ...
      snapshot => {
        ...
        snapshot.forEach(doc => {
          ...
          row.querySelector(".btn-assign")?.addEventListener("click", async () => {
            if ((admin.department || "").toLowerCase() === "admin department") {
              // Admin Head → Drivers Trip Ticket
              mountAdminDriversTicketModal(admin, {
                ...order,
                id: doc.id,
                collection: collectionName
              });
            } else if ((admin.department || "").toLowerCase() === "it department") {
              // IT Department → IT Service Orders
              ...
              // HR Department → Travel Orders
              mountAdminTravelOrderModal(admin, {
                ...order,
                id: doc.id,
                collection: collectionName
              });
