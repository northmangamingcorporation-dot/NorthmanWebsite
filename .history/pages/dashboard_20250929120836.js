  ...
  return `
    ...
    ">
      ...
      ">
        ...
        <button class="tab-button active" data-target="it-requests-content" onclick="switchTab('it-requests-content')">IT Requests</button>
        <button class="tab-button" data-target="hr-requests-content" onclick="switchTab('hr-requests-content')">HR Requests</button>
        <button class="tab-button" data-target="accomplishments-content" onclick="switchTab('accomplishments-content')">Accomplishments</button>
...
/**
 * Switches visible tab content by tab ID.
 * @param {string} tabId - The ID of the tab content to show (e.g., 'it-requests-content').
 */
function switchTab(tabId) {
  // Select all tab content elements
  const tabContents = document.querySelectorAll('.tab-content');

  tabContents.forEach(tab => {
    if (tab.id === tabId) {
      tab.classList.add('active');
      tab.style.display = ''; // Show (remove inline display:none)
      // Optionally trigger animation by reflow
  ...
  // Optional: Update active state of tab buttons/links
  // Assuming tab buttons have data-target attribute matching tab content IDs
  const tabButtons = document.querySelectorAll('[data-target].tab-button');
