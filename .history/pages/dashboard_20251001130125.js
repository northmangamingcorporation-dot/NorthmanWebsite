    ...
    <tr style="transition: all 0.3s ease;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
      <td style="padding: 16px; border-bottom: 1px solid #f1f5f9;">
        <div style="display: flex; align-items: center; gap: 12px;">
          <i class="fas fa-${getLeaveIcon(leave.type)}" style="color: #22c55e; font-size: 18px;"></i>
          <span style="font-weight: 600; color: #0f172a; text-transform: capitalize;">${leaveTypeLabels[leave.type] || leave.type}</span>
        </div>
      </td>
