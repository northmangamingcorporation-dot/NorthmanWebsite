              ...
              <td colspan="5" style="padding: 16px; text-align: right;">
                <div style="display: flex; justify-content: flex-end; align-items: center; gap: 12px;">
                  <span style="color: #334155; font-size: 15px; font-weight: 700;">
                    <i class="fas fa-calendar-day" style="margin-right: 8px; color: #10b981;"></i>
                    <span id="ticketsDateDisplay" style="color: #64748b; font-weight: 500;"></span>
                    <span style="margin: 0 8px; color: #cbd5e1;">•</span>
                    Total: <span id="ticketsTotalCount" style="color: #10b981; font-size: 18px;">0</span> tickets
                  </span>
                </div>
              </td>
            </tr>
...
function updateFilterInfo(searchValue, typeFilter) {
  // Update date display when filters change
  updateTicketsDateDisplay();
}

// Update the date display in footer
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', updateTicketsDateDisplay);
} else {
  updateTicketsDateDisplay();
}
