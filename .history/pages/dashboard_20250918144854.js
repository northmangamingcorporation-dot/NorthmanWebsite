      ...
      <main class="main">
        ...
        <div class="table">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
            ...
            <button id="newRequestBtn" class="btn" onClick="handleNewRequestClick()">+ New Request</button>
          </div>
...
function mountDashboard(user) {
  ...
  setTimeout(() => {
    ...
    console.log("New Request button:", newReqBtn);
    console.log("Logout button:", backBtn);

    if (newReqBtn) {
      newReqBtn.addEventListener("click", () => {
        console.log("Clicked New Request button");
        if (typeof closeAllModals === "function") closeAllModals();
        if (typeof mountRequestModal === "function") {
          mountRequestModal();
        } else {
          console.error("mountRequestModal() not found!");
        }
      });
    }
