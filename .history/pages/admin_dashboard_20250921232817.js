...
function renderAdminDashboard(admin = { username: "Admin", position: "" }) {
  const isIT = (admin.position || "").toLowerCase().includes("it");
  ...
  return `
    ...
    <div class="container app">
      <main class="main">
        ...
        <!-- IT Features Section -->
        ${isIT ? `
        <div class="card" style="margin-top:20px; padding:16px; border:1px solid #eee; border-radius:8px; background:#fafafa;">
          <h4 style="margin:0 0 12px 0">IT Management Tools</h4>
