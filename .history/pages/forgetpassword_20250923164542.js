...
function mountForgetPassword(prefill = "") {
  try {
    // Remove any existing forget password modal
    const existingModal = document.getElementById("forgetPasswordModal");
    if (existingModal) {
    ...
    console.error("Error mounting forget password modal:", error);
    alert("Unable to load reset form. Please refresh the page and try again.");
  }
}
