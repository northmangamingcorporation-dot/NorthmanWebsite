...
async function loadAccomplishments(currentUser  ) {
  ...
  // Show loading overlay (matching loadOrders design, with high-contrast text)
  const loadingOverlay = document.createElement("div");
  loadingOverlay.id = "dashboard-loading-accomplishments";
  ...
  loadingOverlay.innerHTML = `
    ...
    ">
      <div style="
        ...
        margin: 0 auto 16px;
      "></div>
      <p style="margin: 0; color: #1e293b; font-weight: 600; font-size: 16px;">Loading your accomplishments...</p>
    </div>
  `;
...
// Helper function to hide loading overlay (reusable, matching loadOrders)
...
function getStatusColor(statusKey) {
  const colors = {
    ...
    default: { bg: 'rgba(107, 114, 128, 0.1)', text: '#374151' } // Darker default text
  };
  return colors[statusKey] || colors.default;
}

// CSS for spinner animation (add to your styles if not present)
