...
<div id="dashboardSection" class="section">
  ...
  <!-- IT Manager Task Card -->
  <h4>Your Task Overview</h4>
    <div class="stat-card">
      <div class="stat-label">IT Manager Tasks</div>
      <div class="stat-value it-manager">
        <div>Pending: <span id="itManagerPending">0</span></div>
        <div>Ongoing: <span id="itManagerOngoing">0</span></div>
        <div>Completed: <span id="itManagerCompleted">0</span></div>
      </div>
    </div>
</div>
