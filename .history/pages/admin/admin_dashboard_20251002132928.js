...
// Mount function that combines render and attach
window.mountAdminDashboard = async function(admin) {
  ...
  appContainer.innerHTML = renderAdvancedAdminDashboard(admin);
  
  // Attach all event listeners and functionality
  await attachAdvancedAdminDashboard(admin);
};