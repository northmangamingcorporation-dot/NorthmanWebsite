  ...
  return `
    ...
    <div class="container app">
      ...
      <aside class="sidebar">
        ...
        <button class="sidebar-btn" data-section="departments">Departments</button>
        <button class="sidebar-btn" data-section="staff">Staff Monitoring</button>
      ...
      <main class="main">
        ...
        <div id="dashboardSection" class="section">
          ...
          <!-- Department Overview -->
          <div class="stats">
            ${["IT", "HR", "Finance", "Operations"].map(dep => `
              <div class="stat-card">
                <div class="stat-label">${dep} Dept</div>
                <div id="dep-${dep.toLowerCase()}" class="stat-value pending">0</div>
              </div>
            `).join('')}
          </div>
        </div>
        ...
        <!-- Department Section -->
        <div id="departmentsSection" class="section">
          ...
          <div class="table-wrapper">
            <table>
              ...
              <tbody id="adminDepartmentsTable">
                <tr><td colspan="5" class="loading">Loading department status...</td></tr>
              </tbody>
            </table>
          </div>
        </div>
          ...
          <div class="table-wrapper">
            <table>
              ...
              <tbody id="adminStaffTable">
                <tr><td colspan="5" class="loading">Loading staff info...</td></tr>
              </tbody>
            </table>
          </div>
        </div>
