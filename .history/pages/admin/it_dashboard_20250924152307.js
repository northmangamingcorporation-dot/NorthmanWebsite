          ...
          <div class="section-header enhanced">
            ...
            <div class="section-controls enhanced">
              <div class="search-container">
                ...
                <input type="text" class="databaseConnect.js:21 Firestore initialized: Ag {_delegate: Xd, _persistenceProvider: Dg, INTERNAL: {…}, _appCompat: Oe}
databaseConnect.js:381 🚀 Enhanced database system initialized with backup and recovery capabilities
logout.js:612 Enhanced logout manager with NGC integration loaded successfully
request_modal.js:614 Request modal system loaded successfully
searchFunctionListener.js:78  Search input '#searchRequestsInput' not found!
attachRequestSearchListener @ searchFunctionListener.js:78
initRequestsFilters @ searchFunctionListener.js:209
logout.js:585 Enhanced logout manager initialized with NGC integration
index.js:1783 Auto-redirecting user: test with role: it manager
it_dashboard.js:648 test
index.js:1906 NGC Page Performance: {domContentLoaded: 34, loadComplete: 2, totalTime: 4106}
(index):154  Deprecated API for given entry type.
(anonymous) @ (index):154
setTimeout
(anonymous) @ (index):148
(index):157 Performance Metrics: {loadTime: 4106, domContentLoaded: 34, firstPaint: 1660, largestContentfulPaint: 0}
" id="searchRequestsInput" placeholder="Search requests..." class="search-input enhanced">
...
function initializeSearchAndFilters() {
  ...
  if (clientSearch) {
    clientSearch.addEventListener("input", debounce(function() {
      filterTable("adminClientsTable", this.value, [0, 1, 2, 4]); // Search in name, username, department, email
    }, 300));
  }
...
function filterTableByColumn(tableId, columnIndex, filterValue) {
  ...
  for (let i = 1; i < rows.length; i++) {
    ...
    if (!filterValue || cell.textContent.toLowerCase().includes(filterValue.toLowerCase())) {
      row.style.display = "";
    } else {
