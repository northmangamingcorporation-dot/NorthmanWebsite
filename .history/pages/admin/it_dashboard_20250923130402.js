...
function renderITAdminDashboard(admin = { username: "ITAdmin", position: "" }) {
  return `
    ${renderNav()}
    <div class="container app" style="display:flex; gap:16px;">
      
      <!-- Sidebar -->
      <aside class="sidebar" style="
        width:220px; background:#f8f9fa; border-radius:12px; padding:16px;
        display:flex; flex-direction:column; gap:12px;">
        <div style="font-weight:600; margin-bottom:12px;">IT Admin Menu</div>
        ...
        <button class="sidebar-btn" data-section="stats">Stats</button>
        <button class="sidebar-btn" id="adminLogoutBtn" style="margin-top:auto; background:red; color:#fff;">Logout</button>
      </aside>

      <!-- Main Content -->
      <main class="main" style="flex:1; background:#fff; border-radius:12px; padding:16px; overflow:auto;">
        ...
        <div id="dashboardSection">
          ...
          <div class="stats" style="display:flex; gap:16px; margin-bottom:16px;">
            <div class="stat">
        ...
        <div id="clientsSection" style="display:none; margin-top:16px;">
          <h4>All Clients</h4>
          <table style="width:100%; border-collapse:collapse;">
            <thead style="color:var(--muted)">
              <tr>
                <th style="padding:8px 0; text-align:left">Name</th>
                <th style="padding:8px 0; text-align:left">Username</th>
                <th style="padding:8px 0; text-align:left">Department</th>
                <th style="padding:8px 0; text-align:left">Position</th>
                <th style="padding:8px 0; text-align:left">Email</th>
              </tr>
            </thead>
            <tbody id="adminClientsTable">
              <tr><td colspan="5" style="padding:12px; text-align:center; color:var(--muted)">Loading clients...</td></tr>
            </tbody>
          </table>
        </div>
      </main>
