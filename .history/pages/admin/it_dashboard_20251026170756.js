    ...
    <table class="enhanced-table">
      ...
      <tbody id="tampermonkeyScriptsTable">
        ...
        <div id="analyticsSection" class="section">
          ...
          <!-- Analytics Content -->
          <div id="cancellationAnalytics" style></div>
...
const refreshAnalyticsBtn = document.querySelector('button[onclick="loadAdvancedAnalytics()"]');
if (refreshAnalyticsBtn) {
    refreshAnalyticsBtn.onclick = function(e) {
        e.preventDefault();
        analyticsLoaded = false; // Reset the flag
