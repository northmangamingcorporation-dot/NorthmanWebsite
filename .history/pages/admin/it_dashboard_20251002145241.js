...
function createEnhancedClientRow(client) {
  ...
  row.innerHTML = `
    ...
    <td>
      <span class="status-badge ${client.status === 'offline' ? 'offline' : 'online'}">
        ${client.status === 'offline' ? 'offline' : 'online'}
      </span>
    </td>
    <td>
    ...
    <td>
      <div class="action-buttons">
        ...
        <button class="btn-icon ${client.status === 'offline' ? 'activate-btn' : 'deactivate-btn'}" 
                data-user="${client.username}" 
                title="${client.status === 'offline' ? 'Online' : 'Offline'}">
          <i class="fas fa-${client.status === 'offline' ? 'user-check' : 'user-times'}"></i>
        </button>
      </div>
    </td>
  `;
  ...
  const modal = createModal("Client Profile", `
    <div class="client-profile">
      ...
      <div class="profile-details">
        ...
        <div class="detail-group">
          <label>Status:</label>
          <span class="status-badge ${client.status === 'offline' ? 'inactive' : 'active'}">
