...
function renderStyles() {
  return `
    <style>
      ...
      /* ADVANCED RESPONSIVE CSS FOR DASHBOARD + HR FEATURES */
...
@media (max-width: 768px) {
  ...
  .accomplishments-section > div:first-child,
  .ticketErrReport-section > div:first-child {
    flex-direction: column;
    gap: 12px;
  }
  ...
  /* Leave/Rest Request Modals */
  #leaveDetailsModal,
  #restDetailsModal {
    padding: 16px !important;
  }
  
  #leaveDetailsModal > div,
  #restDetailsModal > div {
  ...
  /* Performance Bar in Tables */
  .performance-bar {
    width: 50px;
  }
  
  /* Leave/Rest status display */
  .status-badge {
...
@media (max-width: 480px) {
  ...
  /* Header Aggressive Simplification */
  .header {
    margin-bottom: 20px;
    gap: 12px;
  }
  ...
  .ticketErrReport-section p {
    font-size: 12px !important;
  }
  
  /* Table - Aggressive Hiding */
  .table-container {
    max-height: 400px;
    border-radius: 8px;
  }
  ...
  #leaveDetailsModal h2 i,
  #restDetailsModal h2 i {
    font-size: 20px !important;
  }
  ...
  /* Leave/Rest table row buttons */
  .requests-section button,
  .hr-requests-section button,
  .accomplishments-section button {
    padding: 8px 12px !important;
    font-size: 12px !important;
  }
  
  /* Table Row Hover - Reduce on Mobile */
  tbody tr:not(.no-data-row):hover {
    transform: none;
    box-shadow: none;
  }
