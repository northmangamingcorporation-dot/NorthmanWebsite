...
// In your dashboard or main mount function, after inserting the HTML
   function attachAccomplishmentsSection(user) {
     ...
     // Load accomplishments data (example - implement based on your needs)
    ...
    async function loadAccomplishments(user) {
     ...
     try {
       ...
       snapshot.forEach(doc => {
         ...
         html += `
           <tr>
             ...
             <td data-label="Description">${data.descriptionOfService?.substring(0, 50)}...</td>
       ...
       tbody.innerHTML = '<tr><td colspan="5" style="text-align: center; color: #ef4444;">Error loading reports. Please try again.</td></tr>';
     }
   }
