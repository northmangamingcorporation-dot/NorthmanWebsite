    ...
    ">
      ...
      ">
        ...
        ">
          ...
          <!-- Leave Request -->
          <div class="action-card" onclick="window.showLeaveRequestModal('${user}')" style="
            background: white;
            border: 2px solid #e2e8f0;
            border-radius: 16px;
            padding: 24px;
          ...
          <!-- Early Rest Day -->
          <div class="action-card" onclick="window.showEarlyRestModal('${user}')" style="
            background: white;
            border: 2px solid #e2e8f0;
            border-radius: 16px;
            padding: 24px;
        ...
        <div class="tab-content" id="accomplishments-content" style="
          ...
          animation: fadeIn 0.5s ease;
        ">
          ${renderAccomplishmentsSection(user)}
        </div>
...
function renderITRequestsSection(user) {
  return `
...
function renderHRRequestsSection(user) {
  window.initializeLeaveForm(user)
  return `
    <div class="hr-requests-section">
      ...
      ">
        ...
        ">
          ...
          <button onclick="window.showLeaveRequestModal('${user}')" style="
            padding: 12px 28px;
            font-size: 15px;
            font-weight: 700;
            border: none;
      ...
      ">
        ...
        ">
          ...
          <button onclick="window.showEarlyRestModal('${user}')" style="
            padding: 12px 28px;
            font-size: 15px;
            font-weight: 700;
            border: none;
