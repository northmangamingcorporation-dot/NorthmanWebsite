...
// Enhanced Back Button Handler with Null Checks, Error Handling, and Promise Safety
// (Updated to prevent null property assignments and unhandled rejections)
...
if (backBtn) {
  backBtn.addEventListener("click", async (e) => {
    ...
    try {
      ...
      if (window.Modal && typeof window.Modal.confirm === "function") {
        confirmed = await window.Modal.confirm("Are you sure you want to logout?", {
          confirmText: "Logout",
          cancelText: "Stay",
          type: "warning"
        });
      ...
      setTimeout(() => {
        try {
          ...
          if (typeof window.mount === "function" && typeof window.renderHome === "function") {
            window.mount(window.renderHome());
            console.log("Redirected to home page.");
          } else if (typeof window.mountLogin === "function") {
            window.mountLogin();
            console.log("Redirected to login page.");
          } else {
            // Ultimate fallback: Reload or redirect
            window.location.href = window.location.origin + window.location.pathname;
            console.log("Fallback redirect initiated.");
          }
          
          // Reset button state (though page will reload)
      ...
      if (backBtn) {
        backBtn.innerHTML = '<i class="fas fa-sign-out-alt"></i> Logout'; // Assuming original icon
  ...
  console.log("Back/Logout button handler attached successfully.");
} else {
