  ...
  return `
    <div id="signInModal" class="modal-overlay" style="
      ...
      <div class="modal-content" style="
        ...
        <!-- Personal Info -->
        <div style="display:flex; flex-wrap:wrap; gap:12px; margin-bottom:16px;"> <input id="firstName" type="text" placeholder="First Name" style="flex:1 1 48%; min-width:140px; padding:12px; border-radius:8px; border:1px solid #ccc; font-size:15px;" /> <input id="lastName" type="text" placeholder="Last Name" style="flex:1 1 48%; min-width:140px; padding:12px; border-radius:8px; border:1px solid #ccc; font-size:15px;" /> </div>
