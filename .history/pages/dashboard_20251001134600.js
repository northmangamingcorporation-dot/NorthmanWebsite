...
// Render Ticket Error Report Section with Teller Rankings + Sorting + Total
    ...
    ">
      ...
      ">
        ...
        ">
          ...
          ">
            <tr>
              <th onclick="sortTable(0)" style="cursor:pointer; text-align: left; padding: 18px 16px; color: #475569; font-weight: 700; font-size: 13px; text-transform: uppercase;">Ticket Code</th>
              <th onclick="sortTable(1)" style="cursor:pointer; text-align: left; padding: 18px 16px; color: #475569; font-weight: 700; font-size: 13px; text-transform: uppercase;">Teller</th>
              <th onclick="sortTable(2)" style="cursor:pointer; text-align: left; padding: 18px 16px; color: #475569; font-weight: 700; font-size: 13px; text-transform: uppercase;">Type</th>
              <th onclick="sortTable(3)" style="cursor:pointer; text-align: left; padding: 18px 16px; color: #475569; font-weight: 700; font-size: 13px; text-transform: uppercase;">Submitted By</th>
              <th onclick="sortTable(4)" style="cursor:pointer; text-align: left; padding: 18px 16px; color: #475569; font-weight: 700; font-size: 13px; text-transform: uppercase;">Date</th>
            </tr>
          </thead>
          ...
          <tfoot style="background:#f9fafb; border-top:2px solid #e2e8f0;">
            <tr>
              <td colspan="5" id="ticketsTotalRow" style="padding: 14px 16px; text-align:right; font-weight:700; color:#334155;">
                Total Tickets: 0
              </td>
            </tr>
          </tfoot>
